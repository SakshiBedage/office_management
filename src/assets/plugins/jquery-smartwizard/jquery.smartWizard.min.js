...
function _defineProperties(t, e) {
  for (var s = 0; s < e.length; s++) {
    var i = e[s];
    i.enumerable = i.enumerable || false; // If enumerable property is not defined, set it to false
    i.configurable = true; // Set configurable property to true
    if ("value" in i) i.writable = true; // If value property is defined, set writable property to true
    Object.defineProperty(t, i.key, i); // Define the property on the target object using Object.defineProperty
  }
}
