...
function QCModule() {
  ...
  const handleApprove = () => {
    swal.fire("Approved!", "You approved.", "success");
  };
  const styles = `
    body {
      margin: 0;
  ...
  const handleCommentSubmit = () => {
    // Define the URL of your Laravel API endpoint for comment submission
    const apiUrl = "https://your-laravel-api-url.com/comment-endpoint";
    ...
    // Make an HTTP POST request to submit the comment
    axios
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="input-group">
                                              <input
                                                ...
                                                id="inputField"
                                                class="form-control"
                                                aria-describedby="microphoneIcon"
                                                value={comment}
                                                onChange={(e) =>
